...
# imagenes
fondo = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\background.png").convert()
...
c1 = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\clouds\c1.png").convert()
c2 = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\clouds\c2.png").convert()
c3 = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\clouds\c3.png").convert()
...
walk_right = []
for i in range(1, 9): # este for forma una lista que va a tener las animaciones para cuando el player este caminando hacia la derecha
    image = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\walk\right\run_r{}.png".format(i)).convert()
...
walk_left = []
for i in range(1, 9): # tiene la misma funcion que el for in range de arriba pero en este caso es para cuando el player este caminando hacia la izquierda
    image = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\walk\left\run_l{}.png".format(i)).convert()
...
jump_right = []
for i in range(1, 9): # este for forma una lista que va a tener las animaciones para cuando el player este caminando hacia la derecha
    image = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\jump\jump_right\jump_r{}.png".format(i)).convert()
    jump_right.append(image)
for image in jump_right: # asi hacemos que el fondo de las imagenes del vector se vuelva transparente
     image.set_colorkey(NEGRO)

jump_left = []
for i in range(1, 9): # este for forma una lista que va a tener las animaciones para cuando el player este caminando hacia la derecha
    image = pygame.image.load(r"C:\Users\Ismael CR\Desktop\Game\texturas\jump\jump_left\jump_l{}.png".format(i)).convert()
    jump_left.append(image)
for image in jump_left: # asi hacemos que el fondo de las imagenes del vector se vuelva transparente
     image.set_colorkey(NEGRO)
